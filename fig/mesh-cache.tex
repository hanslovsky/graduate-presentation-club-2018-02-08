\begin{tikzpicture}
    ...
    \begin{scope}[shift={(9.75,0)}]
        ...
        \begin{scope}[shift={(0,-0.3)}]
            ...
            \visible<25->{
                ...
                \filldraw[fill opacity=0.8,fill=blue] (0.5,0.85) -- +(0.3,-0.2) -- +(0.65,0.2) -- cycle;
                \filldraw[fill opacity=0.8,fill=blue] (0.5,0.75) -- +(0.05,-0.3) -- +(0.45,-0.2) -- cycle;
            }
    ...
    \begin{scope}[shift={(0,-2)}]
        \visible<4->{
            ...
            \node[anchor=east] at (firstRequest.west) {Meshes for};
            \node[anchor=west] at (firstRequest.east) {at highest resolution};
        }
    \end{scope}
